...
exports.UnbanUsers = void 0;
const command_1 = require("../command");
class UnbanUsers extends command_1.Command {
    ...
    handle() {
        this.bot.command('unban', (ctx) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            ...
            yield ctx.conversation.enter('unBanUsers');
            return;
        }));
    }
}
exports.UnbanUsers = UnbanUsers;
