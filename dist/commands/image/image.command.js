...
class ImageCommand extends command_1.Command {
    constructor(_bot, _adminService, _loggerService) {
    ...
    handle() {
        this.bot.command('image', (ctx) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            ...
            yield ctx.conversation.enter('setProductImage');
            return;
        }));
    }
}
